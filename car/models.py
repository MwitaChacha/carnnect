...
class Profile(models.Model):
    ...
    category = models.CharField(max_length=60,choices=CATEGORY_CHOICES, default="Car-Owner")
    def __str__(self):
        return self.user     
...
class Post(models.Model):
    ...
    make = models.CharField(max_length=60,choices=MODEL_CHOICES, default="Toyota",null=True)
